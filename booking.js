...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const ICONS = {
    ...
    touch: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="2"/><path d="M12 4v2M12 18v2M4 12h2M18 12h2"/><path d="M6.5 6.5l1.4 1.4M16.1 16.1l1.4 1.4M6.5 17.5l1.4-1.4M16.1 7.9l1.4-1.4"/></svg>',
    panel: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="3" width="14" height="18" rx="2"/><path d="M9 21v-4a3 3 0 0 1 6 0v4"/></svg>',
    ear: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 10a6 6 0 1 1 8 5.66V17a3 3 0 0 1-6 0"/><path d="M11 12a2 2 0 1 0 2-2"/></svg>',
    frontCam: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="4"/><circle cx="12" cy="12" r="3"/></svg>',
  };

  const SERVICES = [
    { key: 'Not Sure About The Issue', icon: ICONS.unsure },
    { key: 'Display Replacement', image: 'broken-display.png' },
    { key: 'Touch Glass Replacement', icon: ICONS.touch },
    ...
    { key: 'Back Panel Replacement', icon: ICONS.panel },
    { key: 'Microphone', image: 'phone-mic.png' },
    { key: 'Headphone Jack', icon: ICONS.jack },
    { key: 'Ringer', image: 'speaker-repair.png' },
    { key: 'Ear Speaker', icon: ICONS.ear },
    { key: 'Front Camera', icon: ICONS.frontCam },
